...
function Clientes(props)
{
    ...
    {
        let cliente = {nome, cpf, email, nascimento, cep, rua, complemento, numeroEnd, bairro, cidade, uf, senha, confirma}
        console.log(cliente)
        ...
        {
            setError(true)
            setErrorMessage(`Error ${err.response.status} - Algo deu errado`)
            console.log(err)
        }
        ...
        <div className="geral">
            ...
            : null}
                ...
                <div className="text-center">  
                    <Button className="formButton" variant="outline-primary" onClick={addCliente} >Adicionar Cliente</Button>{' '}
                </div>

                <p><Link to='/tecnicos'> ou criar como Técnico</Link></p>
